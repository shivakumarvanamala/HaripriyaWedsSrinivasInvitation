    ...
    >
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          className="btn-gold flex h-9 w-9 items-center justify-center rounded-full bg-[#25D366] text-jade-deep"
        >
        ...
        <a
          ...
          className="btn-gold flex h-9 w-9 items-center justify-center rounded-full bg-gold-gradient text-jade-deep"
        >
