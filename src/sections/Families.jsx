...
export default function Families({ content }) {
  ...
  return (
    <section id="families" className="section-pad relative bg-jade-deep-radial jali">
      <div className="mx-auto max-w-5xl text-center">
        ...
        {/* BRIDE'S FAMILY FIRST — they are the hosts on this invitation, so
            their card leads and carries the welcoming note. The groom-side site
            renders the same two cards in the opposite order. */}
        <div className="flex flex-col items-center justify-center gap-8 md:flex-row md:items-stretch">
          <FamilyCard side={fam.brideSide} icon={BrideIcon} delay={0} />
          ...
          <FamilyCard side={fam.groomSide} icon={GroomIcon} delay={0.2} />
        </div>
