...
export default function Hero({ content, opened, setOpened }) {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-jade-radial">
      ...
      <AnimatePresence>
        {!opened && [
            <motion.div
              ...
              style={{
                backgroundImage: 'linear-gradient(135deg,#17362B,#0F2A21 55%,#08201A)',
            ...
            <motion.div
              ...
              style={{
                backgroundImage: 'linear-gradient(225deg,#17362B,#0F2A21 55%,#08201A)',
                boxShadow: 'inset 12px 0 40px rgba(0,0,0,0.6)',
              }}
            >
            ...
            >
              <span className="flex h-32 w-32 items-center justify-center rounded-full border border-gold/60 bg-jade-soft text-gold shadow-glow animate-glow md:h-40 md:w-40">
      ...
      >
        ...
        {/* Couple names — stacked (3 lines) on mobile, single row on desktop.
            ...
            BRIDE FIRST: this is the bride-side invitation, so it reads
            "హరి ప్రియ వివాహం శ్రీనివాస్". The groom-side site has the same block
            with the two names the other way round. */}
        ...
        >
          ...
          <span className="relative inline-flex items-center justify-center">
            ...
            <motion.a
              href="#savethedate"
              className="btn-gold btn-animated relative z-10 inline-flex items-center gap-2 overflow-hidden rounded-full bg-gold-gradient px-8 py-3.5 font-heading text-lg tracking-widest text-jade-deep"
              animate={
                opened
                  ? {
                      y: [0, -22, 0, -9, 0, 0],
