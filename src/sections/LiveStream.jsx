      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <div
            ...
            // The bezel around the 16:9 screen — antique gold.
            style={{ background: 'linear-gradient(135deg,#806320,#6E5615 45%,#574310)' }}
          >
        ...
        <div className="mt-7 flex flex-col items-center gap-3">
          ...
          {watchUrl && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-gold inline-flex items-center gap-2 rounded-full bg-gold-gradient px-6 py-2.5 font-heading text-sm tracking-widest text-jade-deep"
            >
...
// image is usually missing or a black frame. This is our own emerald/gold panel, so
      ...
      <div
        ...
        style={{
          background:
            ...
            // on a near-black screen; now a faint gold tint on the cream one.
            'radial-gradient(circle at 50% 45%, rgba(110,86,21,0.14), rgba(110,86,21,0.05) 55%, transparent 78%)',
        }}
      />
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center gap-3 px-5 text-center">
        ...
        {hasStream && (
          <motion.button
            ...
            className="btn-gold btn-animated group relative mt-1 flex h-16 w-16 items-center justify-center rounded-full bg-gold-gradient text-jade-deep md:h-20 md:w-20"
        ...
        {/* the couple + when — bride first, as everywhere on this site */}
        <p className="mt-1 whitespace-nowrap font-deco text-2xl text-foil md:text-4xl">
          {t(content.couple.bride.name)} &amp; {t(content.couple.groom.name)}
        </p>
