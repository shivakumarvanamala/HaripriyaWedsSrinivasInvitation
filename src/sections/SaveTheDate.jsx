...
export default function SaveTheDate({ content }) {
  ...
  return (
    <section id="savethedate" className="section-pad relative overflow-hidden bg-jade-deep-radial jali">
      <div className="relative mx-auto max-w-2xl text-center text-cream">
        ...
        <div className="relative flex justify-center">
          ...
          >
            ...
            >
              <div className="flex h-full w-full flex-col items-center justify-center rounded-2xl bg-jade-soft px-4 text-center">
