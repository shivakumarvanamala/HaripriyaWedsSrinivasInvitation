...
export default function Venue({ content }) {
  ...
  return (
    <section id="venue" className="section-pad relative bg-jade-deep-radial jali">
          ...
          <div className="p-7">
            ...
            {venue.directionsUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="btn-gold mt-5 inline-block rounded-full bg-gold-gradient px-6 py-2.5 font-heading tracking-widest text-jade-deep"
              >
                {t(ui.directions)}
              </a>
            )}
